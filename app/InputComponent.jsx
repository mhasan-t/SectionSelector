...
export default function InputComponent({
  ...
  return (
    <View
      style={[styles.input, isErr && { borderWidth: 2, borderColor: "red" }]}
      key={index}>
      <View style={styles.inputPromt}>
        ...
        <TextInput
          ...
          defaultValue={input[0]}></TextInput>
      </View>
      <View style={styles.inputPromt}>
        ...
        maxLength={1}
          ...
          defaultValue={input[1]}></TextInput>
      </View>
      ...
      <View style={styles.btnContainer}>
        <View style={styles.daysContainer}>
          <Picker
            ...
            <Picker.Item label="Saturday and Tuesday" value="sat,t" />
